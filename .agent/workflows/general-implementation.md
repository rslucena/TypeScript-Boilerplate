...
4. **Development Cycle**:
   ...
   - **Act Validation**: Before sending any Pull Request, run `./bin/act` to simulate GitHub Actions locally. If any action fails, analyze and fix the code before proceeding.

5. **Documentation & Cleanup**:
   - **Validation**: Check if `README.md` or `backend/docs/` needs updates, additions, or improvements based on the change.
