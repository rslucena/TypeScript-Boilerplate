...
# Welcome to the TypeScript Boilerplate

Here you'll find comprehensive information about this minimalistic project template/boilerplate designed to kickstart Node.js back-end applications in TypeScript.

## 🎯 Quick Navigation

**New here?** → [Getting Started](./getting-started.md) | [Complete Example](./api-example.md)  
**Building features?** → [Domain Generator](../development/domain-scaffolding.md) | [Template System](../development/template-system-architecture.md)  
**Understanding the code?** → [Architecture](../architecture/index.md) | [Best Practices](../development/best-practices.md)  
**Testing?** → [Testing Guide](../development/testing-guide.md)  
**Deploying?** → [CI/CD Pipeline](../devops/ci-cd-pipeline.md) | [Deployment Guide](../devops/deployment.md)  
