...
description: API logic reference for error handling.
---
<script setup>
import { MarkerType } from '@vue-flow/core'
const nodes = [
  { id: "route", type: "multi-handle", label: "Route Throws Error", position: { x: 225.2825411250741, y: -44.63334735990512 }},
  { id: "handler", type: "multi-handle", label: "Global Error Handler", position: { x: 221.2825411250741, y: 80.47212796505039 }},
  { id: "type", type: "multi-handle", label: "Identify Type", position: { x: 248.5, y: 206 }},
  { id: "zod", type: "multi-handle", label: "Extract Paths", position: { x: 0, y: 350 }},
  { id: "custom", type: "multi-handle", label: "Extract Code/Message", position: { x: 211.29122218842406, y: 362.3538652590136 }},
  { id: "unknown", type: "multi-handle", label: "Mask Details/Log", position: { x: 500, y: 350 }},
  { id: "format", type: "multi-handle", label: "Format Response", position: { x: 232.704588637381, y: 509.8830922072109 }},
  { id: "client", type: "multi-handle", label: "Return JSON", position: { x: 250, y: 632.1200496734353 }},
];

const edges = [
  { id: "e2", source: "handler", target: "type", sourceHandle: "bottom-source", targetHandle: "top", label: "Validate", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e3", source: "type", target: "zod", sourceHandle: "left-source", targetHandle: "top", label: "Zod Validation", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e4", source: "type", target: "custom", sourceHandle: "bottom-source", targetHandle: "top", label: "Custom Business", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e5", source: "type", target: "unknown", sourceHandle: "right-source", targetHandle: "top", label: "Unknown / 500", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e6", source: "zod", target: "format", sourceHandle: "bottom-source", targetHandle: "left", label: "Execute SQL", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e7", source: "custom", target: "format", sourceHandle: "bottom-source", targetHandle: "top", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e8", source: "unknown", target: "format", sourceHandle: "bottom-source", targetHandle: "right", label: "No", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "e9", source: "format", target: "client", sourceHandle: "bottom-source", targetHandle: "top", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
  { id: "vueflow__edge-routebottom-source-handlertop", source: "route", target: "handler", sourceHandle: "bottom-source", targetHandle: "top", animated: true, markerEnd: MarkerType.ArrowClosed, type: "smoothstep"},
];
