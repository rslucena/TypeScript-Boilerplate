...
If you need the raw OpenAPI JSON specification (for example, to import into Postman, Insomnia, or generate client SDKs), you can usually fetch it from the API directly:
